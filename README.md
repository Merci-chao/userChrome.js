...
## Cautions
- This script needs to override some private functions of Firefox and requires `security.allow_unsafe_dangerous_privileged_evil_eval` to be enabled on Firefox 139+ for this purpose, which may lower the security of your browser. The said setting is needed to be disabled through `about:config` manually after disabling or removing this script. Please note that and use this script at your own risk.
