...
- Currently, this script is not fully compatible with Firefox's native [tab groups](https://support.mozilla.org/kb/tab-groups) feature when there are multiple rows:
