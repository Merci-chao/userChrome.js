...
| `tabsUnderControlButtons` | <p>🔸 **Full-Width Tab Bar Usage**</p><p>Tabs starting from the second row make full use of the entire tab bar width:</p><ul><li>`0` - never</li><li>`1` - when the tab bar is not scrollable (legacy option, not recommended)</li><li>`2` - always</li></ul> |
