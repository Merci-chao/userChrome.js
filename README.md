...
| `tabsUnderControlButtons` | <p>🔸 **Tabs Fill Full Tab Bar from Second Row**</p><p>Tabs starting from the second row fill the full tab bar row:</p><ul><li>`0` - never</li><li>`1` - when the tab bar is not scrollable (legacy option, not recommended)</li><li>`2` - always</li></ul> |
