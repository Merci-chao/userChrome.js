...
| `smartWindowButtonOnNavBar` | <p>🔸 **Smart Window Button on Navigation Toolbar**</p><p>On classic windows, move the Firefox Smart Window switching button to the navigation toolbar. Forcibly activated when `tabsAtBottom` is enabled. Available on Firefox 149 to 153.</p> |
...
| `tabsUnderControlButtons` | <p>🔸 **Tabs Fill Full Tab Bar from Second Row**</p><p>Tabs starting on the second row are arranged to span the full width of the tab bar row:</p><ul><li>`0` - never</li><li>`1` - when the tab bar is not scrollable (legacy option, not recommended)</li><li>`2` - always</li></ul> |
