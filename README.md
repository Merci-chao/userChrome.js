...
2. Install the script loader (*userChrome.js*). Skip to step 3 if you already have one in use. There are several script loaders available:
   ...
   <p>There is no difference among them for applying this script, so simply choose your preferred one. If you have no preference, you can try <em>MrOtherGuy/fx-autoconfig</em>, which provides an update checking feature.</p>
