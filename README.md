...
## Installation
1. If you are not using any scripts, follow the instructions in the [Tab Mix Plus - Docs](https://onemen.github.io/tabmixplus-docs/other/installation/#install-firefox-scripts) to install the script loader (Firefox Scripts). You can skip this step if you have already installed some scripts.<br>**🔔 Please make sure that no other Tabs Bar-related scripts and CSS styles are currently active.**<br>
