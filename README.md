...
| `tabsUnderControlButtons` | <p>🔸 **Tabs Use Full Tab Bar from Second Row**</p><p>Tabs starting from the second row utilize the full width of the tab bar:</p><ul><li>`0` - never</li><li>`1` - when the tab bar is not scrollable (legacy option, not recommended)</li><li>`2` - always</li></ul> |
