...
| `smartWindowButtonOnNavBar` | <p>🔸 **Smart Window Button on Navigation Toolbar**</p><p>On classic windows, move the Firefox Smart Window switching button to the navigation toolbar. Forcibly activated when `tabsAtBottom` is enabled. Available on Firefox 149 to 153. Directly move the button via Customize Toolbar mode on Firefox 154+.</p> |
