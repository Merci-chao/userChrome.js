...
💡🐞 You're welcome to post your suggestions and bug reports [here](https://github.com/Merci-chao/userChrome.js/discussions/new/choose). Including a screen recording or screenshot is strongly recommended. 
...
2. Install the script loader (*userChrome.js*). Skip to step 3 if you already have one in use. There are several script loaders available:
	- [*onemen/firefox-scripts*](https://github.com/onemen/firefox-scripts) (with installer and updater developed with vibe-coding) <p>🚧 [UNDER MAINTENANCE](https://github.com/onemen/firefox-scripts/issues/157) 🚧</p> <details><summary><del>Installation Steps (Installer)</del></summary><ol><li><p>Download the installer for your OS from the [official page](https://github.com/onemen/firefox-scripts/releases) or from the direct links below:</p><ul><li>[`installer_win.exe`](https://github.com/onemen/firefox-scripts/releases/download/latest/installer_win.exe) — Windows</li><li>[`installer_linux`](https://github.com/onemen/firefox-scripts/releases/download/latest/installer_linux) — Linux (x86_64)</li><li>[`installer_linux_aarch64`](https://github.com/onemen/firefox-scripts/releases/download/latest/installer_linux_aarch64) — Linux (ARM64)</li></ul></li><li><p>Run the installer while Firefox is running.</p></li><li><p>In the installation page shown in Firefox, install the required components (admin rights may be needed):</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/firefox-scripts-installer.png"></li><li><p>Verify that the installation works correctly:</p><ul><li>Paste `chrome://firefox-scripts/content/ui/updater.html` into the address bar and press `Enter`.</li><li>Confirm that the page is displayed and all items are green in state.</li></ul></li><li><p>When an update is released, update the components in the updater page shown in Firefox:</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/firefox-scripts-updater.png"></li></ol></details><details><summary><del>Installation Steps (Manual)</del></summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above.</p><ol><li><p>Get the source files needed for setup from the [official page](https://github.com/onemen/firefox-scripts/releases), or from the following direct links:</p><ul><li>[`fx-folder.zip`](https://github.com/onemen/firefox-scripts/releases/download/latest/fx-folder.zip)</li><li>[`utils.zip`](https://github.com/onemen/firefox-scripts/releases/download/latest/utils.zip)</li></ul></li><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Extract the required files into the correct folders:</p><ul><li>Open the `fx-folder.zip` file and from the `fx-folder` folder, extract the `config.js` file and the `defaults` folder directly into the program folder (admin rights may be needed).</li><li>Create the `chrome` folder in the profile folder if not exist.</li><li>Create the `utils` folder in the `chrome` folder if not exist.</li><li>Open the `utils.zip` file, extract all files directly into the `utils` folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li><li><p>Confirm that the setup is working correctly:</p><ul><li>Paste `chrome://firefox-scripts/content/ui/updater.html` into the address bar and press `Enter`.</li><li>If it shows *File not found*, wait for a minute and try again.</li><li>Confirm that the page is displayed and all items are green in state.</li></ul></li><li><p>When an update is released, update the components in the updater page shown in Firefox:</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/firefox-scripts-updater.png"></li></ol></details>
	- [*onemen/firefox-scripts*](https://onemen.github.io/tabmixplus-docs/other/installation/#install-firefox-scripts) (traditional) <details><summary>Installation Steps</summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above.</p><ol><li><p>Get the source files needed for setup from the [official page](https://onemen.github.io/tabmixplus-docs/other/installation/#install-firefox-scripts), or from the following direct links:</p><ul><li>[Configuration files (`fx-folder.zip`)](https://github.com/onemen/TabMixPlus/releases/download/dev-build/fx-folder.zip)</li><li>[Utils (`utils.zip`)](https://github.com/onemen/TabMixPlus/releases/download/dev-build/utils.zip)</li></ul></li><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Extract the required files into the correct folders:</p><ul><li>Open the `fx-folder.zip` file and from the `fx-folder` folder, extract the `config.js` file and the `defaults` folder directly into the program folder (admin rights may be needed).</li><li>Create the `chrome` folder in the profile folder if not exist.</li><li>Create the `utils` folder in the `chrome` folder if not exist.</li><li>Open the `utils.zip` file, extract all files directly into the `utils` folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li><li><p>Confirm that the setup is working correctly:</p><ul><li><p>Open *[about:config](https://support.mozilla.org/kb/about-config-editor-firefox)* and search for `userChromeJS.enabled`. Verify that the preference exists without a delete button (🗑️) on the right. If the delete button is present, click it to delete the preference, then restart Firefox and recheck.</p></li></ul></li></ol><p>⛔ DO NOT install *Tab Mix Plus* as it will cause conflict.</p></details>
	- [*MrOtherGuy/fx-autoconfig*](https://github.com/MrOtherGuy/fx-autoconfig) (with update-checking feature) <details><summary>Installation Steps</summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above.</p><ol><li><p>Get the `fx-autoconfig-master.zip` file from the [direct link](https://github.com/MrOtherGuy/fx-autoconfig/archive/refs/heads/master.zip), or from the [official page](https://github.com/MrOtherGuy/fx-autoconfig):</p><ul><li>Click the green *Code* button.</li><li>Select *Download ZIP*.</li></ul></li><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Extract the `fx-autoconfig-master.zip` file and place the contents into the correct folders:</p><ul><li>From the `fx-autoconfig-master\program` folder, place the `config.js` file and the `defaults` folder directly into the program folder (admin rights may be needed).</li><li>From the `fx-autoconfig-master\profile` folder, place the `chrome` folder directly into the profile folder.</li></ul></li><li><p>If you already have scripts in use:</p><ul><li>Option A: Move all `*.uc.js` files from the `chrome` folder into the `chrome\JS` sub-folder.</li><li>Option B: Edit the `chrome\utils\chrome.manifest` file and change <code>content userscripts <mark>../JS/</mark></code> to <code>content userscripts <mark>../</mark></code>. This will load scripts directly from the `chrome` folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li><li><p>Confirm that the setup is working correctly:</p><ul><li>Check that a new menu item *userScripts* appears under the *Tools* menu (`Alt`+`T`).</li></ul></li><li><p>Additionally, enable the automatic update checking feature:</p><ul><li>Open *[about:config](https://support.mozilla.org/kb/about-config-editor-firefox)*, paste `userChromeJS.updates.update-check.enabled` into the search box, and click the Add button (✚) to create a boolean preference set to `true`.</li></ul></li></ol></details>
 	- [*alice0775/userChrome.js*](https://github.com/alice0775/userChrome.js) <details><summary>Installation Steps</summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above (Japanese).</p><ol><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Go to the [official page](https://github.com/alice0775/userChrome.js), find the *Go to file* search box on the left of the green *Code* button, or simply press the `T` key to focus it:</p><ul><li>Type `userChrome.js` and choose the latest version, typically called `xxx/userChrome.js`. Click the download button to save the file.<br><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/github-download-file.png"></li><li>Type `install_folder` and choose the latest version, typically called `xxx/install_folder`. Download both the `config.js` and `defaults/pref/config-prefs.js` files.</li></ul><p>⚠️ Creating the files by copy-paste or other methods may cause incorrect encoding.</p></li><li><p>Place the required files into the program folder:</p><ul><li>Place the `config.js` file into the program folder (admin rights may be needed).</li><li>Place the `config-prefs.js` file into the `defaults\pref` sub-folder under the program folder.</li></ul></li><li><p>Place the required file into the profile folder:</p><ul><li>Create the `chrome` folder in the profile folder if not exist.</li><li>Place the `userChrome.js` file into the `chrome` folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li><li><p>Confirm that the setup is working correctly:</p><ul><li><p>Press `Ctrl`+`Shift`+`J` to open the *Browser Console*. Enable the *Logs* filter, enter `getScripts` in the *Filter Output*, and verify that the related logs appear.</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/alice-scriptloader-en.png"></li></ul></li></ol></details>
 	- [*BSTweaker/UserChromeJS*](https://bitbucket.org/BSTweaker/userchromejs/src/master/loader/) <details><summary>Installation Steps</summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above (Japanese).</p><ol><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Prepare the required files:</p><ul><li><p>Go to the [official page](https://bitbucket.org/BSTweaker/userchromejs/src/master/loader/), copy the source code shown there, and save it as a file named `config.js` using UTF-8 encoding without BOM.</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/BSTweaker-config-js.png"></li><li><p>Create a file named `config-prefs.js` with the following content, also saved in UTF-8 encoding without BOM:</p><pre>pref("general.config.obscure_value", 0);<br>pref("general.config.filename", "config.js");<br>pref("general.config.sandbox_enabled", false);</pre></li><li><p>Download the [`UserChromeJSLoader.mjs`](https://bitbucket.org/BSTweaker/userchromejs/src/master/loader/UserChromeJSLoader.mjs) file:</p><img src="https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/BSTweaker-save-file.en.png"></li></ul></li><li><p>Place the required files into the program folder:</p><ul><li>Place the `config.js` file into the program folder (admin rights may be needed).</li><li>Place the `config-prefs.js` file into the `defaults\pref` sub-folder under the program folder.</li></ul></li><li><p>Place the required file into the profile folder:</p><ul><li>Create the `chrome` folder in the profile folder if not exist.</li><li>Place the `UserChromeJSLoader.mjs` file into the `chrome` folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li><li><p>Confirm that the setup is working correctly:</p><ul><li>Check that a new menu item *UserChromeJSLoader* appears under the *Tools* menu (`Alt`+`T`).</li></ul></li></ol></details>
 	- [*Endor8/userChrome.js*](https://github.com/Endor8/userChrome.js) <details><summary>Installation Steps</summary><p>📝 Note: These steps are provided as a simple reference. For complete and accurate instructions, please consult the official page above (German).</p><ol><li><p>Get the `Firefox-anpassungen.zip` file from the [direct link](https://raw.githubusercontent.com/Endor8/userChrome.js/master/userChrome/Dateien/Firefox-anpassungen.zip), or from the [official page](https://github.com/Endor8/userChrome.js/tree/master/userChrome).</p></li><li><p>Open *[about:support](https://support.mozilla.org/kb/use-troubleshooting-information-page-fix-firefox)* in Firefox to locate the program folder and the profile folder:</p><ul><li>Under *Application Binary*, find the path to `firefox.exe` (e.g., `C:\Program Files\Mozilla Firefox`).</li><li>Under *Profile Folder*, click *Open Folder* to access it.</li></ul></li><li><p>Extract the `Firefox-anpassungen.zip` file and place the contents into the correct folders:</p><ul><li>Place the `userChromeJS` folder and the `config.js` file into the program folder (admin rights may be needed).</li><li>Place the `config-prefs.js` file into the `defaults\pref` sub-folder under the program folder.</li><li>Place the `chrome` folder into the profile folder.</li></ul></li><li><p>Click the *Clear startup cache…* button at the top right  of *about:support* to restart Firefox.</p></li></ol></details>
