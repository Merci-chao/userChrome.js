...
## Compatibility
- Firefox 115, 134 and 135 Beta, for Windows 7 to 11.
...
- This script is not fully compatible with Firefox's native tab groups feature. Dragging tab to create new group is disabled when there are multiple rows, and drag animation is disabled when there is any tab group.
