...
急に壊れる心配や、更新を探し回る煩わしさはありません。自動アップデート確認機能を備えており、ワンクリックで最新の改善や互換性をゲットできます。より細かくコントロールしたい場合は、手動更新や無効化も可能です。

![アップデート通知](https://cdn.jsdelivr.net/gh/Merci-chao/userChrome.js@main/screenshots/update.en.png)
