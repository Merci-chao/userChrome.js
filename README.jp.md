...
## 注目ポイント
- **🗂️ タブグループ対応：** マウス操作をフルサポートし、より滑らかで洗練された操作体験を実現。
- **🎞️ 強化されたタブアニメーション：** タブに関連する各種動作にスムーズなアニメーションを追加。
- **📐 スペース活用の最適化：** ウィンドウ制御ボタン下のスペースも含め、UI 領域を最大限に活用。
- **🖱️ 滑らかなドラッグ体験：** 多段でもドラッグのアニメーションをサポート。
- **📌 ピン留めタブのグリッド表示：** タブバーがスクロール可能際、ピン留めされたタブをコンパクトなグリッドに固定。
- **🛠️ カスタマイズ可能な設定：** 豊富なオプションと機能を提供し、お好みに合わせて体験を細かく調整できる。
- **🔄 自動アップデートチェック：** 常に最新の機能強化を備え、最新の Firefox バージョンとの完全な互換性を確保。
